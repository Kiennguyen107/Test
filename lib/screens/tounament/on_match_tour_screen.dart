...
class OnMatchTourScreen extends StatefulWidget {
  late dynamic selectedTeam1;
  late dynamic selectedTeam2;
  late dynamic numberMatch;
  OnMatchTourScreen({super.key, required this.selectedTeam1, required this.selectedTeam2, required this.numberMatch});

  @override
  State<OnMatchTourScreen> createState() => _OnMatchTourScreenState();
}

class _OnMatchTourScreenState extends State<OnMatchTourScreen> {
  ...
  void _endMatch() {
    ...
    Navigator.pop(context, matchResult); // Pass the result back to the previous screen
  }
